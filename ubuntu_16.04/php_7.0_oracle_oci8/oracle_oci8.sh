...
# Download php dist
cd /tmp
wget https://www.php.net/distributions/php-7.0.31.tar.gz
tar -xzvf php-7.0.31.tar.gz

# Install oci8
cd /tmp/php-7.0.31/ext/oci8
phpize
